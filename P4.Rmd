...
combinedDataSetForModel <- IPDataSet %>%
  mutate(isSpam = factor(isSpam), country_code = factor(country_code), city = factor(city) , country_name = factor(country_name), region_name = factor(region_name)) %>% 
